...
function scribble_set_transform(xscale, yscale, angle)
{
	global.scribble_state_xscale = xscale;
	global.scribble_state_yscale = yscale;
	global.scribble_state_angle  = angle;
}